...
INSTALLED_APPS = [
    ...
    'django_ckeditor_5',
    # 'users', чтобы срабатывали сигналы
...
WSGI_APPLICATION = 'fan_board.wsgi.application'
...
CKEDITOR_5_FILE_STORAGE = 'posts.utils.CkeditorCustomStorage'
